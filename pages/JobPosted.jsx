                  ...
                  <View
                    ...
                    <View style={{ paddingHorizontal: 30, marginTop: 14 }}>
                      <Ripple
                        rippleColor="white"
                        onPress={() =>
                          navigation.push("RecommendedUser", { job: item.id })
                        }>
                        <Text
                          style={{
                      ...
                      <Ripple
                        rippleColor="white"
                        onPress={() =>
                          navigation.push("AppliedByJob", { job: item.id })
                        }>
                        <Text
                          style={{
                      ...
                      <Ripple
                        rippleColor="white"
                        onPress={() =>
                          navigation.push("OffersByJob", { job: item.id })
                        }>
                        <Text
                          style={{
