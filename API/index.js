...
export const fetchSeekerByEmail = (email) => API.post('/seekers/email', { email: email })
...
export const updateCompany = (size, country, city, code, phone, headquater, email, type, id) => API.put('/companies/update', {
    size: size,
    country: country,
    city: city,
    code: code,
...
export const verifyCompany = (verify, code, phone, id) => API.put('/companies/verify', {
    verify: verify,
    code: code,
    phone: phone,
    id: id,
